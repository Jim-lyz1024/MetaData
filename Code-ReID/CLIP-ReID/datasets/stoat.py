...
class STOAT(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'stoat_train')
        self.query_dir = osp.join(self.dataset_dir, 'stoat_query')
        self.gallery_dir = osp.join(self.dataset_dir, 'stoat_gallery')
